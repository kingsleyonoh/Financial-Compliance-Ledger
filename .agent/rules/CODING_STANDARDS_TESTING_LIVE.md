# Financial Compliance Ledger — Coding Standards: Live & E2E Testing
...
- Your database (local PostgreSQL, local NATS JetStream) — validates schema, column names, constraints, query behavior
...
| Run command | `go test ./...` | `make test-e2e` |
