# Financial Compliance Ledger — Coding Standards: Domain & Production
...
2. Tests run against local services (local PostgreSQL, local NATS JetStream)
...
1. **All tests pass** — `go test ./...` shows 0 failures
